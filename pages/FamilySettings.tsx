...
const FamilySettings: React.FC = () => {
  ...
  const { user, members, tasks } = useApp();
  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden bg-background-light dark:bg-background-dark font-display text-[#111813] dark:text-white">
      <header className="flex items-center bg-background-light dark:bg-background-dark p-4 pb-2 justify-between sticky top-0 z-10">
        ...
        <h1 className="text-[#111813] dark:text-white text-lg font-bold leading-tight tracking-[-0.015em] flex-1 text-center">Mi Familia</h1>
        <div className="flex w-12 items-center justify-end">
          <button className="flex cursor-pointer items-center justify-center overflow-hidden rounded-full h-12 w-12 bg-transparent text-[#111813] dark:text-white">
      ...
      <main className="flex-grow px-4">
        ...
        <div className="mb-6 rounded-lg bg-white dark:bg-background-dark/50 p-4 shadow-sm">
          ...
          <p className="mb-3 text-xs text-gray-500 dark:text-gray-400">Comparte este código para invitar a nuevos miembros.</p>
          <div className="flex items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 dark:border-gray-700 dark:bg-gray-800 p-3">
            ...
            <p className="flex-grow select-all text-base font-bold tracking-widest text-[#111813] dark:text-white">XJ4-T9P-2K</p>
            <button className="flex h-8 w-8 items-center justify-center rounded-full bg-gray-200 text-gray-700 hover:bg-gray-300 dark:bg-gray-700 dark:text-gray-200 dark:hover:bg-gray-600">
